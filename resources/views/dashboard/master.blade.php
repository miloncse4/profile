...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="{{route('home')}}"><i>Admin Panlel</i></a>
            <!-- Sidebar Toggle-->
                    ...
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapsePages" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
                                ...
                                <a class="nav-link" href="{{route('service.create')}}">Services Create</a>
                                <a class="nav-link" href="{{route('service.index')}}">Services view</a>
                                </nav>
                            </div>
                            ...
                            <a class="nav-link" href="{{route('expriance.create')}}">
